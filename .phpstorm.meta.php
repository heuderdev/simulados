...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\simulados\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\simulados\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'livewire-alert.denyButtonText','livewire-alert.showCancelButton','livewire-alert.showConfirmButton','livewire-alert.backdrop','logging.default',
...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','profile','learning.module.form',
'exam.category.form','admin.dashboard','administrativo.categorias-exames.index','register','login',
'password.request','password.reset','verification.notice','verification.verify','password.confirm',
'storage.local',);
        registerArgumentsSet('views', 
'ExamCategory.ExamCategoryForm','LearningModule.LearningModuleForm','admin.AdministrativoGeralNavegacao','admin.categoria-exame.categoria-exame-form','components.action-message',
...
'components.form.input','components.form.textarea','components.input-error','components.input-label','components.modal',
'components.nav-link','components.painel.action-card','components.primary-button','components.responsive-nav-link','components.secondary-button',
'components.svg','components.text-input','dashboard','layouts.app','layouts.guest',
'livewire.admin.administrativo-geral','livewire.admin.categoria-exame.categoria-exame','livewire.exam-category.exam-category','livewire.layout.navigation','livewire.learning-module.learning-module',
...
'profile','volt-livewire::admin.administrativo-geral','volt-livewire::admin.categoria-exame.categoria-exame','volt-livewire::exam-category.exam-category','volt-livewire::layout.navigation',
'volt-livewire::learning-module.learning-module','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password','volt-livewire::pages.auth.login','volt-livewire::pages.auth.register',
